...
# Connect to Pixhawk (use serial for autonomous operation)
...
# Safety countdown
print("[SAFETY] Mission starting in:")
for i in range(5, 0, -1):
    print(f"[COUNTDOWN] {i}...")
    time.sleep(1)
print("[GO] Mission starting now!")
...
print("[4] Forward movement complete.")
